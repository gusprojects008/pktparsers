...
from pktparsers.core.definitions import (IEEE802_11, RELATIONSHIPS, ANNOTATIONS)
from .definitions import (ROLE, SSIDS, CHANNELS_SEEN, FRAMES_SENT, FRAMES_RECEIVED, RETRY_COUNT)
